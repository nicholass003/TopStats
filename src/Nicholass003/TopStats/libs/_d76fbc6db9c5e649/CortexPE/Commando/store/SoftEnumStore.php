...
namespace Nicholass003\TopStats\libs\_d76fbc6db9c5e649\CortexPE\Commando\store;


use Nicholass003\TopStats\libs\_d76fbc6db9c5e649\CortexPE\Commando\exception\CommandoException;
...
class SoftEnumStore {
	...
	public static function updateEnum(string $enumName, array $values):void {
		...
		self::$enums[$enumName] = $enum = new CommandSoftEnum($enumName, $values);
